...
export const region: RegionConfig = {
    ...
    landmarks: ['동탄역', '북광장', '남광장', '동탄테크노밸리'],
    nearbyStations: ['동탄역'],

    seo: {
        titleSuffix: '서우실장',
        mainKeywords: [
            '동탄 가라오케', '동탄 하이퍼블릭', '동탄 셔츠룸',
            '동탄 호빠', '동탄 기모노룸', '동탄 룸살롱'
        ],
        description: '동탄 가라오케·하이퍼블릭 메인 가이드. 동탄역·북광장·남광장 중심 상권에서 비즈니스 및 파티를 위한 최적의 코스를 안내합니다.',
    },
    ...
    venueTypes: [
        {
            id: 'hyperpub',
            name: '하이퍼블릭',
            slug: 'dongtan-hyperpub-guide',
            subtitle: '프라이빗 / 시크릿',
            description: '동탄역 중심 프라이빗 라운지',
