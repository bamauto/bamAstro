...
export const region: RegionConfig = {
    ...
    seo: {
        ...
        homeTitle: '수원 유흥 완벽 가이드 | 가라오케·하이퍼블릭·셔츠룸 추천 | 서우실장',
        homeDescription: '수원역·팔달문 최고급 가라오케·하이퍼블릭 완벽 가이드. 2026년 최신 가격, 프로 에티켓, 추천 업소 총정리. 회식·데이트·비즈니스 전문. ★ 서우실장 무료 상담',
        blogListTitle: '수원 유흥 가이드 블로그 | 프로 팁·에티켓·2026 트렌드 | 서우실장',
        blogListDescription: '수원 유흥 전문가가 알려주는 실전 팁과 에티켓. 15년 경력 서우실장의 인사이더 정보, 가라오케·하이퍼블릭 이용 가이드, 2026 최신 트렌드 총정리.',
        naverVerification: '',
        googleVerification: '',
        longTailKeywords: [
            // 기본 키워드
    ...
    venueTypes: [
        {
            ...
            subtitle: '프라이빗 / 시크릿',
            description: '삼성전자 수원사업장 임직원 접대 명소. 수원역 로데오거리 중심부에서 강남급 서비스를 합리적인 가격에 경험하세요.',
        ...
        },
        {
            ...
            subtitle: '프리미엄 가라오케',
            description: '경기 남부 최대 규모의 프리미엄 가라오케. 인계동에서 최신 음향과 넓은 파티룸으로 단체 회식과 모임에 최적화되어 있습니다.',
        ...
        },
        {
            ...
            subtitle: '캐주얼 라운지',
            description: '수원역 인근 직장인들의 가벼운 회식 명소. 강남 대비 30% 저렴한 가격에 편안한 분위기에서 네트워킹을 즐기세요.',
        ...
        },
        {
            ...
            subtitle: '이색 체험',
            description: '수원화성 관광 후 특별한 문화 체험. 일본식 정통 서비스와 이국적 인테리어로 잊지 못할 밤을 선사합니다.',
        ...
        },
        {
            ...
            subtitle: '하이엔드 비즈니스',
            description: '삼성디지털시티 VIP 고객을 위한 격조 높은 비즈니스 공간. 인계동 고급 업소는 중요한 거래처 접대에 최적입니다.',
        ...
        },
        {
            ...
            subtitle: '여성 전용',
            description: '수원 여성 전문직을 위한 안전한 프라이빗 공간. 세련된 호스트들의 품격 있는 서비스로 특별한 시간을 보내세요.',
