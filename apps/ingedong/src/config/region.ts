...
export const region: RegionConfig = {
    ...
    seo: {
        ...
        homeTitle: '인계동 유흥 완벽 가이드 | 가라오케·하이퍼블릭·셔츠룸 추천 | 서우실장',
        homeDescription: '인계동 먹자골목·수원역 최고급 가라오케·하이퍼블릭 완벽 가이드. 2026년 최신 가격, 프로 에티켓, 추천 업소 총정리. 회식·데이트·비즈니스 전문. ★ 서우실장 무료 상담',
        blogListTitle: '인계동 유흥 가이드 블로그 | 프로 팁·에티켓·2026 트렌드 | 서우실장',
        blogListDescription: '인계동 유흥 전문가가 알려주는 실전 팁과 에티켓. 15년 경력 서우실장의 인사이더 정보, 가라오케·하이퍼블릭 이용 가이드, 2026 최신 트렌드 총정리.',
        naverVerification: '',
        googleVerification: '',
        longTailKeywords: [
            '인계동 먹자골목 가라오케',
    ...
    venueTypes: [
        {
            ...
            subtitle: '프라이빗 / 시크릿',
            description: '수원 인계동 먹자골목 최고의 프라이빗 라운지. 삼성전자·수원시청 고객들의 비즈니스 접대 명소로 강남급 서비스를 합리적 가격에 제공합니다.',
        ...
        },
        {
            ...
            subtitle: '프리미엄 가라오케',
            description: '인계동 대표 프리미엄 가라오케. 최신 음향 시스템과 넓은 파티룸을 갖추고 있어 단체 회식과 기업 행사에 최적화되어 있습니다.',
        ...
        },
        {
            ...
            subtitle: '캐주얼 라운지',
            description: '수원 직장인들의 가벼운 회식 핫플레이스. 부담 없는 가격과 편안한 분위기에서 즐기는 캐주얼 네트워킹 공간입니다.',
        ...
        },
        {
            ...
            subtitle: '이색 체험',
            description: '인계동에서 만나는 이색 문화 체험 공간. 일본식 정통 서비스와 이국적 인테리어로 특별한 밤을 선사합니다.',
        ...
        },
        {
            ...
            subtitle: '하이엔드 비즈니스',
            description: '삼성디지털시티 VIP 고객을 위한 격조 높은 비즈니스 공간. 인계동 핵심 상권에서 중요한 거래처 접대에 최적입니다.',
