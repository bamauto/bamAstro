...
export const region: RegionConfig = {
    ...
    seo: {
        ...
        homeTitle: '평택 유흥 완벽 가이드 | 가라오케·하이퍼블릭·셔츠룸 추천 | 서우실장',
        homeDescription: '평택역·송탄·고덕 최고급 가라오케·하이퍼블릭 완벽 가이드. 2026년 최신 가격, 프로 에티켓, 추천 업소 총정리. 회식·데이트·비즈니스 전문. ★ 서우실장 무료 상담',
        blogListTitle: '평택 유흥 가이드 블로그 | 프로 팁·에티켓·2026 트렌드 | 서우실장',
        blogListDescription: '평택 유흥 전문가가 알려주는 실전 팁과 에티켓. 15년 경력 서우실장의 인사이더 정보, 가라오케·하이퍼블릭 이용 가이드, 2026 최신 트렌드 총정리.',
        naverVerification: '',
        googleVerification: '',
        longTailKeywords: [
            // 기본 키워드
    ...
    venueTypes: [
        {
            ...
            subtitle: '프라이빗 / 시크릿',
            description: '삼성전자 평택캠퍼스·평택항 임직원 비즈니스 접대 명소. 경기 남부 최저가 수준으로 프리미엄 서비스를 제공합니다.',
        ...
        },
        {
            ...
            subtitle: '프리미엄 가라오케',
            description: '평택역·송탄 지역 대표 가라오케. 최신 음향 시설과 넓은 파티룸을 갖추고 있어 삼성전자 단체 회식에 적합합니다.',
        ...
        },
        {
            ...
            subtitle: '캐주얼 라운지',
            description: '삼성전자 평택캠퍼스 젊은 직장인들의 회식 핫플레이스. 경기남부 최고의 가성비로 편안한 네트워킹을 즐기세요.',
        ...
        },
        {
            ...
            subtitle: '이색 체험',
            description: '평택에서 즐기는 이색 문화 체험. 일본식 테마와 이국적 인테리어로 특별한 접대나 기념일에 추천합니다.',
        ...
        },
        {
            ...
            subtitle: '하이엔드 비즈니스',
            description: '삼성전자 평택캠퍼스·고덕신도시 VIP 고객을 위한 비즈니스 공간. 품격 있는 거래처 접대에 최적입니다.',
