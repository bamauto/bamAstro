...
// Current region ID for filtering
const REGION_ID = region.id; // 'gangnam'
...
// Fetch all published blog posts (with scheduled filter and region filter)
...
// Fetch paginated blog posts (with scheduled filter and region filter)
...
// Fetch single blog post by slug (with scheduled filter and region filter)
...
// Fetch featured blog post (with scheduled filter and region filter)
